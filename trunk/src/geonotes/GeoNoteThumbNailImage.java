...
*/
public class GeoNoteThumbNailImage extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            if (geoNote!=null){
                ...
                response.getOutputStream().write(geoNote.imageThumbnail.getBytes());
            }
        } catch (Exception e) {
            System.err.println(GeoNoteThumbNailImage.class.getName() + ": " + e);
            e.printStackTrace();
        } finally {
            if (pm!=null) {
                pm.close();
